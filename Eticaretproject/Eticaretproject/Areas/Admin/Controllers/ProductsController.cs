...
namespace Eticaretproject.Areas.Admin.Controllers
{
    public class ProductsController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Adi,CategoryID,marka,model,imageUrl,Açıklama,fiyat,vergi,stok,indirim,IsActive,CreateDate,CreateUserID,UpdateDate,UpdateUserID")] Product product)
        {
            if (ModelState.IsValid)
            {
